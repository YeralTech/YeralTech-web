  ...
  return (
    <nav id="navbar" className="flex items-center justify-between px-8 lg:px-0 max-w-screen-md mx-auto ">
      ...
      <ul
        ...
        } flex-col absolute top-10 left-10 ml-12 text-center px-10 py-4 bg-white shadow-md z-20 md:left-96 md:ml-36 lg:static lg:flex lg:flex-row lg:items-center lg:gap-2 lg:bg-transparent lg:shadow-none lg:w-auto`}
      >
