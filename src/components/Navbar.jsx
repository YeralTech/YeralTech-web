  ...
  return (
    <nav id="navbar" className="flex items-center justify-between px-8 lg:px-0 max-w-screen-md mx-auto ">
      ...
      <ul
        ...
        } flex-col absolute top-16 left-96 ml-12 text-center w-40 py-4 bg-white shadow-md z-20 md:ml-60 lg:static lg:flex lg:flex-row lg:items-center lg:gap-2 lg:bg-transparent lg:shadow-none lg:w-auto`}
      >
